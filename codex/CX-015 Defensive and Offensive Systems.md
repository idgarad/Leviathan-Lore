...
- **Kinetic Weapons (Railguns, Cannons):**
    - Generate waste heat equal to 1% of their MJ output per shot.
    - $H_{waste,kinetic} = 0.01 \times E_{shot}$

- **Plasma Weapons:**
    - Generate waste heat equal to 10% of their MJ output per shot.
    - $H_{waste,plasma} = 0.10 \times E_{shot}$

- **Beam Weapons:**
    - Generate waste heat equal to 25% of their MJ output per tick.
    - $H_{waste,beam} = 0.25 \times E_{tick}$
